...
export const Chat = memo(({ stopConversationRef }: Props) => {
  ...
  const { getChatResponse } = useApiService();
  ...
  async (message: Message, deleteCount = 0) => {
    if (selectedConversation) {
      ...
      // Optionally update conversation name if it's the first message
      ...
      try {
        ...
        // (adjust 'response' if your backend returns a different key)
